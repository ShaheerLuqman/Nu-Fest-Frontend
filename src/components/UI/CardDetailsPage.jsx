    ...
    <div className="flex justify-center">
      <div className="flex flex-col md:flex-row items-start gap-8 p-6 border border-gray-300 rounded-lg xl:max-w-[80%]">
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          {/* Title and Price */}
          <div>
            <h1 className="text-2xl font-bold second">Bento Cake Decoration</h1>
            <p className="text-xl font-semibold second">Rs 2,500</p>
          </div>
          ...
          <div className="border-t border-gray-300 pt-4">
            ...
            <p className="second">01 Day Experience</p>
          </div>
        </div>
      </div>
    </div>
